...
/** Hearthstone theme front for admin preview - reads from props instead of store */
function AdminHearthstoneFront({
  card,
  illustrationUrl,
}: {
  card: CardData;
      ...
      >
        ...
        >
          {imgSrc ? (
            ...
            >
              <span style={{ color: '#6B5B3E', fontSize: '12px', fontFamily: "'Nanum Myeongjo', serif" }}>
                No Image
              </span>
            </div>
          )}
...
/** Hearthstone theme back for admin preview - reads from props instead of store */
function AdminHearthstoneBack({
  card,
}: {
  card: CardData;
}) {
  ...
  return (
    <div>
      <div className="max-w-xs mx-auto">
        {side === 'front' ? (
          isHearthstone ? (
            <AdminHearthstoneFront card={card} illustrationUrl={illustrationUrl} />
          ) : isPokemon ? (
          ...
          <AdminHearthstoneBack card={card} />
        ) : isPokemon ? (
