...
export function TarotStatInput() {
  const cardNumber = useCardStore((state) => state.card.tarotMeta?.cardNumber ?? 0);
  const mystique = useCardStore((state) => state.card.tarotMeta?.mystique ?? 100);
  const setCardNumber = useCardStore((state) => state.setTarotCardNumber);
  const setMystique = useCardStore((state) => state.setTarotMystique);
