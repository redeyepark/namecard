 ...
 * Each theme has a distinct border color and label for visual differentiation.
 */
...
/**
 * Simplified card thumbnail for the public gallery grid.
 * Shows only the front face with illustration, display name, and theme badge.
 * Supports all 5 themes with distinct visual styles.
 */
export function CardThumbnail({ card }: CardThumbnailProps) {
  ...
  const imgSrc = card.illustrationUrl
    ...
    : null;
  const displayName = card.card.front.displayName || '';
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 p-3">
          ...
          >
            {renderMultiLine(displayName)}
          </h3>
        </div>

        {/* Bottom gradient overlay with name and title */}
        <div
