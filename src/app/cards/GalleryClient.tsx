...
import type { GalleryEventGroup } from '@/types/card';
 ...
 * Displays all cards grouped by event with status indicators.
 */
export function GalleryClient({ groups, totalCards }: GalleryClientProps) {
  return (
          ...
          <div className="space-y-10">
            {groups.map((group) => (
              <section key={group.eventId ?? '__unassigned'}>
                ...
                {/* Card grid - responsive: 2 col mobile, 3 tablet, 4 desktop */}
