    ...
    <div className="min-h-screen bg-[#f5f5f5]">
      ...
      <header className="bg-primary text-secondary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
          <Link
            href="/"
            className="inline-block text-xs text-secondary/50 hover:text-secondary/80 transition-colors mb-4"
          >
            &larr; 홈으로
          </Link>
          <div className="flex items-baseline gap-3">
            ...
            {totalCards > 0 && (
              <span className="text-sm sm:text-base text-secondary/40 font-mono">
                {totalCards}
              </span>
            )}
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-4">
        <Link
          ...
          className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-primary border border-border-medium hover:border-[rgba(2,9,18,0.4)] transition-all duration-200"
        >
