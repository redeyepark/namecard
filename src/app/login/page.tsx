...
function LoginContent() {
  ...
  const errorMessages: Record<string, string> = {
    ...
    OAuthAccountNotLinked: '이 이메일은 이미 다른 로그인 방식으로 등록되어 있습니다.',
      ...
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border border-gray-300 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 shadow-sm"
          >
            {/* Google icon */}
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-gray-900 border border-gray-900 rounded-xl text-sm font-medium text-white hover:bg-gray-800 transition-all duration-200 shadow-sm"
          >
            {/* GitHub icon */}
