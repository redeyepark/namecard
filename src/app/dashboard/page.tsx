    ...
    <div className="min-h-screen bg-secondary">
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="flex items-center gap-2 mb-6">
          <h1 className="font-[family-name:var(--font-figtree),sans-serif] text-2xl sm:text-3xl font-bold text-primary">
        ...
        <div className="grid grid-cols-2 gap-3 mb-10">
          <Link
            href="/create"
            className="group flex items-center gap-3 p-4 bg-primary text-secondary hover:bg-primary/90 transition-colors"
          >
          ...
          <Link
            ...
            className="group flex items-center gap-3 p-4 bg-surface text-primary border border-border-medium hover:border-primary/40 transition-colors"
          >
            <svg className="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="true">
        ...
        {/* Request List */}
        <h2 className="font-[family-name:var(--font-figtree),sans-serif] text-lg font-bold text-primary mb-4">
          내 요청 현황
        </h2>
        ...
        {isAdmin && (
          <div className="mt-12 text-center">
            <Link href="/admin" className="text-xs text-primary/40 hover:text-primary/70 transition-colors">
              관리자 페이지
            </Link>
          </div>
        )}
